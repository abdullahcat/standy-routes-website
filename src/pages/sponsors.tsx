    ...
    >
      ...
      <section className="py-16">
        ...
        <div className="max-w-3xl mx-auto text-center px-4">
          <h2 className="text-3xl font-bold mb-6">Haydi Başlayalım</h2>
          <p className="mb-6">
            Öğrencilere etkili bir şekilde ulaşmak ve iş yükünüzü azaltmak istiyorsanız; 
            hemen bir görüşme ayarlayalım, ihtiyaçlarınıza en uygun etkinlikleri belirleyelim!
          </p>
          <Link
    target='_blank'
        className="mx-2 rounded-full inline-flex px-5 py-2   transition duration-300 ease-in-out bg-standy-pink text-white hover:bg-standy-dark-pink"
